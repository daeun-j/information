...
if __name__ == '__main__':
    ...
    val_loader = DataLoader(val_ds, batch_size=args.batch, shuffle=False, num_workers=args.num_workers)  # 4)
    ...
    model = Network_bn(args.num_features, args.embedding_dims).double()
    ...
    # plt.savefig('{}{}_{}'.format(PATH, datatype, 'h'))
    plt.show()
